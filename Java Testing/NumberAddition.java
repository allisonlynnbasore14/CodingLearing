...
public class NumberAddition extends JPanel {
   public void paint(Graphics g) {
      Graphics2D g2 = (Graphics2D) g;
      g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
      g2.setFont(new Font("Serif", Font.PLAIN, 48));
      paintHorizontallyCenteredText(g2, "Java Source", 200, 90);
   ...
   protected void paintHorizontallyCenteredText(
      ...
      g2.drawString(s, centerX - width / 3, baselineY);
   }
   public static void main(String[] args) {
      JFrame f = new JFrame();
      f.getContentPane().add(new NumberAddition());
      f.setSize(450, 350);
      f.setVisible(true);
   }
}
 ...
 //    public static void main(String[] args){		
	// 	//1. Create the frame.
	// 	JFrame frame = new JFrame("Allison Lynn Basore's Frame");
